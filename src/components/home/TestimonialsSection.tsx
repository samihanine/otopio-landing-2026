          ...
          <div className="relative z-10 p-8 flex flex-col justify-center h-full gap-8">
            {[
              ...
              >
                ...
                <p className="text-white/60 mt-1 text-caption">{stat.label}</p>
              </motion.div>
            ))}
          </div>
        </motion.div>
          ...
          <div className="relative z-10 p-8 flex flex-col justify-between h-full">
            ...
            <div className="mt-auto relative h-[200px] md:h-[240px]">
              <AnimatePresence initial={false} custom={direction}>
                ...
                >
                  <p className="text-primary mb-2 uppercase tracking-widest text-overline font-semibold">
                  ...
                  <div>
                    <p className="text-white text-base-body font-medium">

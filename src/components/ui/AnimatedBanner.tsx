...
export function AnimatedBanner() {
  ...
  return (
    <div className="w-full bg-[#111] overflow-hidden py-4 md:py-6 relative z-10 shadow-[0_4px_20px_rgba(0,0,0,0.1)] border-y border-[#222]">
      {/* 
          ...
          <Fragment key={arrayIndex}>
            {bannerItems.map((item, index) => (
              <div
                ...
                className="flex items-center px-8 md:px-12 text-[#999] hover:text-white transition-colors duration-300"
              >
                <span
                ...
                <div className="w-2 h-2 rounded-full bg-[#ff5500] ml-16 md:ml-24 opacity-80 shadow-[0_0_8px_rgba(255,85,0,0.5)]"></div>
              </div>
            ))}
          </Fragment>
        ))}
